...
//  $src[1] = "../src/1-services-citsci.json";
...
//exit;
      echo "Creating file: " . $target_folder . "cases-per-country.json\n";
      if (file_put_contents($target_folder . "cases-per-country.json", json_encode($prj_per_country, JSON_PRETTY_PRINT))) {
        echo "Done." . "\n\n";
      }
      echo "Creating file: " . $target_folder . "cases-per-country.js\n";
        if (file_put_contents($target_folder . "cases-per-country.js", "var prj_per_country = " . json_encode($prj_per_country, JSON_PRETTY_PRINT))) {
        echo "Done." . "\n\n";
      }
    }
