  ...
  foreach ($d as $p) {
    if ($p["id"] != $id) {
      if ($technology == $p["technology"]) {
        $related_projects[$p["id"]]["technology"] = "Yes";
      }
      ...
      if ($primary_sector == $p["primary_sector"]) {
        $related_projects[$p["id"]]["primary_sector"] = "Yes";
      }
      if ($secondary_sector == $p["secondary_sector"]) {
        $related_projects[$p["id"]]["secondary_sector"] = "Yes";
      }
      if ($uptake == $p["uptake"]) {
        $related_projects[$p["id"]]["uptake"] = "Yes";
      }
      if ($cross_sector == $p["cross_sector"]) {
        $related_projects[$p["id"]]["cross_sector"] = "Yes";
      }
      if ($type == $p["type"]) {
        $related_projects[$p["id"]]["type"] = "Yes";
      }
/*      
